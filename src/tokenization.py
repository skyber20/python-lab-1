...
def func_tokenization(input_from_user: str) -> list[tuple[str, str]]:
    """
    Функция, преобразующая входное арифметическое выражение от пользователя в токены (OPERATOR, NUMBER, BRACKET)
